 ...
 * can be used with [[org.apache.spark.SparkConf]].
 */
private[config] class TypedConfigBuilder[T](
 ...
 */
private[config] case class ConfigBuilder(key: String) {
